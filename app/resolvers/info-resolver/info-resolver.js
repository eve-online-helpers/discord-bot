...
var InfoResolver = (function () {
    function InfoResolver(searchService, characterService, corporationService) {
    ...
    InfoResolver.prototype.resolveMessage = function (input) {
        return __awaiter(this, void 0, Bluebird, function () {
            var query, searchResult, characterId, characterResult, corporationResult, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        characterResult = _a.sent();
                        return [4 /*yield*/, this.corporationService.getCorporationInfoById(characterResult.corporation_id)];
                    case 3:
                        corporationResult = _a.sent();
                        result = '\n```';
...
InfoResolver = __decorate([
    ...
    __param(2, inversify_1.inject(inversify_types_1.TYPES.CorporationService)),
